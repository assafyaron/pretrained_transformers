...
if args.function == 'pretrain':
    ...
    # If pretrained model weights are specified, load them
    if args.reading_params_path is not None:
        gpt_model.load_state_dict(torch.load(args.reading_params_path))
        epochs = 10  # With pretrained model
    else:
        epochs = 75  # Without pretraining
    ...
    # Train & save the model
    finetune_trainer = trainer.Trainer(gpt_model, finetune_dataset, eval_dataset, trainer_config)
